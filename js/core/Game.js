...
export class Game {
    ...
    handleEjectMassCollisions() {
        for (let i = this.ejectMasses.length - 1; i >= 0; i--) {
            ...
            for (const cell of this.player.cells) {
                ...
                // Prioriza a célula mais próxima no frame atual (self-feed em células coladas).
            ...
            this.player.absorbMass(bestCell, ejectMass.mass);
    ...
    ensurePlayerAlive() {
        if (this.player.cells.length > 0) return;
